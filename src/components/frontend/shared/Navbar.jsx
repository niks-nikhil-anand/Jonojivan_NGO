      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        ...
        <div className="hidden grow items-start lg:flex">
          <ul className="ml-12 inline-flex space-x-8">
            {menuItems.map((item) => (
              <li key={item.name}>
                <Link href={item.href} className="inline-flex items-center text-sm font-semibold text-black hover:text-gray-500">
                  {item.name}
                </Link>
              </li>
            ))}
        ...
        <div className="hidden lg:flex items-center space-x-4">
          ...
          <Link href="/profile">
            <motion.div
              className="inline-flex items-center space-x-2 text-black cursor-pointer hover:text-gray-500 relative"
