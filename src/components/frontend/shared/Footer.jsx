          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-1 space-y-4 lg:space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-sm">
                ...
                <a href="mailto:support@plantoempowerfoundation.org" className="hover:text-pink-500 transition-colors break-all">
                  support@plantoempowerfoundation.org
                </a>
              </div>
              <div className="flex items-center space-x-3 text-sm">
                <Phone className="h-4 w-4 text-pink-500 flex-shrink-0" />
                <a href="tel:+919599322679" className="hover:text-pink-500 transition-colors">
                  +91 95993 22679
                </a>
              </div>
