...
const FooterBanner = () => {
  return (
    <div className="bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 flex flex-col md:flex-row items-center justify-between px-4 md:px-8 py-6 md:py-12 text-white">
      ...
      <button className="group bg-white text-blue-600 hover:bg-blue-50 border-2 border-white hover:border-blue-200 px-8 py-4 md:px-10 md:py-5 font-bold text-lg uppercase rounded-full transition-all duration-300 flex items-center space-x-3 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95">
