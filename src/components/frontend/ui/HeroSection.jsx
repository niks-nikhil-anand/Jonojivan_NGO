...
const HeroSection = () => {
  ...
  return (
    <div className="relative max-h-[60vh] h-[60vh] overflow-hidden">
      {/* Slides */}
      ...
      {/* Content */}
      <motion.div
        className="relative flex flex-col items-center justify-center h-full text-white text-center px-4 sm:px-6 lg:px-8"
        ...
        <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
          <DialogTrigger asChild>
            ...
            >
              <Button 
                size="lg"
                className="bg-[#e91e63] hover:bg-[#d81b60] text-white font-semibold py-2.5 px-6 sm:py-3 sm:px-8 text-sm sm:text-base shadow-lg hover:shadow-xl transition-all duration-300"
              >
                Donate Now
          ...
          <DialogContent className="sm:max-w-md bg-white/95 backdrop-blur-md border border-border/50">
            <DialogHeader className="sr-only">
              <DialogTitle>Donation Form</DialogTitle>
              <DialogDescription>Make a donation to support our cause</DialogDescription>
            </DialogHeader>
      ...
      {/* Slider Dots */}
      <motion.div
        className="absolute bottom-4 sm:bottom-6 lg:bottom-8 left-1/2 transform -translate-x-1/2 flex gap-2 sm:gap-3 z-10"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      <motion.div
        className="absolute top-10 right-10 w-20 h-20 sm:w-32 sm:h-32 bg-gradient-to-br from-green-500/20 to-blue-600/20 rounded-full blur-xl"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.6, 0.3],
        }}
      ...
      <motion.div
        className="absolute bottom-20 left-10 w-16 h-16 sm:w-24 sm:h-24 bg-gradient-to-br from-blue-500/20 to-green-600/20 rounded-full blur-lg"
        animate={{
          scale: [1.2, 1, 1.2],
          opacity: [0.4, 0.2, 0.4],
        }}
