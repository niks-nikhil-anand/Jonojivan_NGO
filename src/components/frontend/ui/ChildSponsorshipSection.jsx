...
import banner from "../../../../public/frontend/canva.png";
...
const ChildSponsorshipSection = () => {
  ...
  useEffect(() => {
    ...
    fetch("/api/sharpen-image")
      ...
      .catch((error) =>
        console.error("Error fetching sharpened image:", error)
      );
  }, []);
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <motion.h2
              ...
              variants={cardVariants}
            >
              What is the Child Sponsorship Program of JonoJivan Foundation?
            </motion.h2>

            {/* Description */}
            <motion.div className="space-y-4 mb-8" variants={cardVariants}>
              <p className="text-lg text-gray-700 leading-relaxed">
                Every child deserves the chance to learn, grow, and dream—yet
                millions, especially in underserved communities, face barriers
                to education. At Jonojivan Foundation, we are committed to breaking these
                barriers by providing children with access to quality education
                and the tools they need to succeed.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                By sponsoring a child, you don&apos;t just provide education—you
              ...
              {sponsorshipBenefits.map((benefit, index) => (
                ...
                >
                  <div className="flex items-start space-x-3">
                    <div
                      className={`inline-flex items-center justify-center w-10 h-10 bg-gradient-to-r ${benefit.color} rounded-xl text-white shadow-lg`}
                    >
                      {benefit.icon}
                    </div>
                    <div>
          ...
          >
            ...
            {/* Main Image */}
            <motion.div
              className="relative rounded-3xl overflow-hidden shadow-2xl h-96 lg:h-[500px]"
