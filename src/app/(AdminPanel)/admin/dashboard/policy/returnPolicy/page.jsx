...
const AddReturnPolicy = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 p-6 w-full">
      ...
      >
        <h2 className="text-xl font-bold mb-4">Add Return Policy</h2>
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="return-policy" className="block text-sm font-medium text-gray-700">Return Policy Content</label>
            <ReactQuill
              id="return-policy"
              value={editorContent}
          ...
          <div className='mt-[5rem]'>
            ...
            >
              {isSubmitting ? 'Submitting...' : 'Save Return Policy'}
            </button>
          </div>
        </form>
      </motion.div>
      ...
      <div className="w-full bg-gray-100 p-6 rounded-lg shadow-md h-85 overflow-y-auto">
        <h2 className="text-xl font-bold mb-4">Return Policy Live View</h2>
        <div
          className="prose"
