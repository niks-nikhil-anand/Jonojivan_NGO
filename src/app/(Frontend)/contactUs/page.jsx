        ...
        <div className="flex justify-center items-center w-full md:w-2/3 lg:w-1/2">
          <form className="mt-8 space-y-6 w-full">
            <div className="flex flex-col md:flex-row md:space-x-4 space-y-4 md:space-y-0">
              <input
                className="w-full h-14 px-6 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-green-500 transition"
                type="text"
                id="first_name"
            ...
            />
            <textarea
              className="w-full h-32 px-6 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition"
              id="message"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              type="submit"
              className="w-full h-12 rounded-md bg-green-600 text-sm font-semibold text-white shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition"
            >
              Send Message
            </motion.button>
          </form>
