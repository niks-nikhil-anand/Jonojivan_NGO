...
const AppointmentLetter = () => {
  ...
  const downloadPDF = async () => {
    ...
    const cardContent =
      clonedElement.querySelector('[class*="CardContent"]') || clonedElement;
    if (cardContent) {
    ...
    try {
      ...
      // Compress image data for smaller file size
      const imgData = canvas.toDataURL("image/jpeg", 0.85); // Changed to JPEG with 85% quality
              ...
              <div className="flex-1 lg:px-6 px-4 lg:pb-4 pb-3 flex flex-col">
                ...
                <div className="space-y-0.5 lg:mb-3 mb-2">
                  ...
                  <p className="lg:text-sm text-sm">
                    {userData ? userData.name : "Umesh Gehlot"}
                  </p>
                  <p className="lg:text-sm text-sm">
                    Flat No AO-1/02, Anubhuti Apartments,
                  </p>
                  <p className="lg:text-sm text-sm">
                    Sitapur Road, Sector CS, Daliganj,
                  </p>
                ...
                <div className="flex-1 space-y-2.5 text-justify lg:text-sm text-sm lg:leading-5 leading-relaxed overflow-y-auto">
                  ...
                  <p>
                    We are delighted to extend this formal appointment letter
                    and welcome you as a valuable member of the{" "}
                  ...
                  <p>
                    ...
                    significantly strengthen our collective efforts toward
                    societal transformation.
                  </p>
                  <p>
                    As a member of the Jonojivan Foundation, you will have the
                    opportunity to actively participate in our initiatives,
                    events, and developmental projects. Your insights and
                    efforts will play a pivotal role in driving our objectives
                    forward.
                  </p>
                  <p>
                    In addition to your active role, you will enjoy the
                    following benefits:
                  </p>
                  <ul className="list-disc list-inside lg:ml-3 ml-2 space-y-0.5">
                    <li>
                      Access to members-only events and training workshops
                    </li>
                    <li>
                    ...
                    <li>
                      Regular updates through our newsletters and project
                      reports
                    </li>
                    <li>
                  ...
                  <p>
                    ...
                    mission. Should you have any questions or require
                  ...
                  <div className="bg-gray-50 lg:p-3 p-2 rounded-md border lg:text-xs text-xs text-gray-700 space-y-1.5">
                    ...
                    <p className="flex items-start gap-2">
                      ...
                      <span>
                        Jonojivan Foundation, Uttar Khatowal, PO- Uttar
                        Khatowal, PS- Rupahihat, Nagaon, Assam – 782124
                      </span>
                    </p>
                  </div>

                  <p>
                    Once again, welcome to the Jonojivan Foundation. We look
                    forward to your support, ideas, and active engagement.
                  </p>

                  <p className="font-medium">
                    This Appointment Letter is verified and officially issued by
                    the organization.
                  </p>
                </div>
                ...
                <div className="lg:mt-4 mt-3">
                  ...
                  <p className="lg:text-xs text-xs text-gray-600">
                    President / Founder
                  </p>
                  <p className="lg:text-xs text-xs text-gray-600">
