          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {volunteerOpportunities.map((opportunity, index) => {
              ...
              return (
                <div
                  key={index}
                  className="glass-card rounded-2xl shadow-xl overflow-hidden slide-up hover-lift cursor-pointer transition-transform duration-300"
                ...
                >
                  <div className="p-8">
                    ...
                    <div
                      className={`bg-gradient-to-r ${opportunity.color} p-4 rounded-full w-fit mb-6`}
                    >
